document.addEventListener('DOMContentLoaded', () => {
    ...
    const cameraPicBtn = document.getElementById('camera-pic-btn');
    ...
    // Camera Modal Logic
    if (cameraPicBtn && cameraModal && cameraVideo && captureBtn) {
        cameraPicBtn.addEventListener('click', async () => {
            try {
