document.addEventListener('DOMContentLoaded', () => {
    ...
    if (addAccountBtnDropdown) {
        addAccountBtnDropdown.addEventListener('click', async (e) => {
            ...
            // Esplicito logout da Supabase per pulire la sessione interna del client
            if (supabase) {
    ...
    window.setCardStyle = function(styleName) {
        ...
        if (budgetCard) {
            ...
            if (styleName !== 'card-style-default') budgetCard.classList.add(styleName);
        }
        if (previewCard) {
            previewCard.classList.remove(...cardClasses);
            if (styleName !== 'card-style-default') previewCard.classList.add(styleName);
        }
